...
contract ChickenFarmContract {
    ...
    function ChickenFarmContract(string _batchId, string _farmId) {
                            ...
                            uint _n2, uint _co2, uint _pm25, uint _light, uint _nativePressure, uint _weight, uint _o2, uint _water) returns (bool) 
    {
        ...
        UpdateTelemetry(_tempDevices, _temperatures, _humidityDevices, _humidity);
      
        return true;
    }

    function UpdateTelemetry(bytes32[] _tempDevices, uint[] _temperatures, bytes32[] _humidityDevices, uint[] _humidity) {
